...
import paneles.facturacion.pnlFacturacion;
import principal.Principal;

public class AlertWarningDeleteFactura extends javax.swing.JDialog {
    ConexionSQL cnn = new ConexionSQL();
    Connection con = cnn.conexion();
    pnlFacturacion pnlFac = new pnlFacturacion();
    Timer timer = null;
    TimerTask task;
    int i = 32;
    String fecha,hora;
    public AlertWarningDeleteFactura(java.awt.Frame parent, boolean modal,String fecha,String hora) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        titulo.setText("Está seguro que desea eliminar el registro?");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cancelar, javax.swing.GroupLayout.PREFERRED_SIZE, 211, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void materialButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_materialButton1ActionPerformed
        pnlFac.limpiar2();
        pnlFac.mostrarDatosTabla();
        String SQL= "";
        try {
                this.dispose();
                SQL = "delete from ttraalqalq where fec_alquiler = ? and hor_alquiler = ?";
                PreparedStatement pst = con.prepareStatement(SQL);
                pst.setString(1, this.fecha);
                pst.setString(2, this.hora);
                if(pst.executeUpdate()>0){
                    AlertSuccess s = new AlertSuccess(new JFrame(), true);
                    s.titulo.setText("Registro eliminado exitosamente");
                    s.setVisible(true);
                }else{
                    AlertError a = new AlertError(new Principal(), true);
                    a.titulo.setText("No se ha podido eliminar el registro");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertWarningDeleteFactura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertWarningDeleteFactura dialog = new AlertWarningDeleteFactura(new javax.swing.JFrame(), true,null,null);
