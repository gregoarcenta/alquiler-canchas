...
public class AlertWarningDelete extends javax.swing.JDialog {
    ...
    public AlertWarningDelete(java.awt.Frame parent, boolean modal, String table, String id) {
        super(parent, modal);
        initComponents();
    ...
    private void materialButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_materialButton1ActionPerformed
        ...
        try {
                this.dispose();
                SQL = table == "tmaeclialq" ? "delete from " + table + " where cedruc_cliente = ?": "delete from " + table + " where cod_cancha = ?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertWarningDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertWarningDelete dialog = new AlertWarningDelete(new javax.swing.JFrame(), true,null,null);
